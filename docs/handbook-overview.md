...
**If you're new to GNP:**
Start with the [README](../README.md), then read [source-of-truth.md](source-of-truth.md) for the full framework definition.

**If you want to apply GNP to a real request:**
Go to the [CASSEROLE Checklist](casserole-checklist.md) and work through it with your request.

**If you want to see what it looks like in practice:**
Browse the [Examples](examples.md) — three before/after cases from the real world.

**If you have questions:**
Check the [FAQ](faq.md) first. If your question isn't there, open a GitHub Discussion.

**If you want to understand where this is heading:**
...
*See [source-of-truth.md](source-of-truth.md) for the canonical definition of all framework elements.*
