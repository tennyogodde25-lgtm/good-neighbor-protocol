# Source of Truth — Good Neighbor Protocol (GNP)

*This document is the canonical definition of the Good Neighbor Protocol framework. When other documents, summaries, or tools conflict with what is written here, this file takes precedence.*
